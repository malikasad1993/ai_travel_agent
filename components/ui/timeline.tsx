      ...
      <div className='max-w-7xl mx-auto py-12 px-4 md:px-8 lg:px-10'>
        ...
        <div className='flex gap-5 items-center text-xl'>
          <div className='flex gap-2 items-center'>
            <Calendar />
            <h2>Duration {tripData.duration} days</h2>
          </div>
          <div className='flex gap-2 items-center'>
            <Wallet />
            <h2>Budget {tripData.budget}</h2>
          </div>
          <div className='flex gap-2 items-center'>
            <Users2 />
            <h2> {tripData.group_size} Person</h2>
          </div>
        </div>
      </div>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className='sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-[40%]'>
              ...
              <h3 className='hidden md:block text-3xl md:pl-20 md:text-lg font-bold text-neutral-500 dark:text-neutral-500 '>
                {item.title}
              </h3>
            </div>
